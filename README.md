...
## Dataset
Transaction-level flight sales data including:
...
## Key Insights
- Revenue is highly dependent on a few airlines  
- High booking routes ≠ high profitability  
- Identified loss-making bookings and routes  
- Small customer segment drives majority of profit  
